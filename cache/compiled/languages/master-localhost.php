...
return [
    ...
    'checksum' => '64710ed3f8cdd505d1656d800c4a3f79',
    'files' => [
        'system/languages' => [
            'cs' => [
...
```',
        ...
        'fr' => [
            'PLUGIN_ADMIN' => [
                'ADMIN_BETA_MSG' => 'Ceci est une version bêta ! Utilisez-la en production à vos risques et périls...',
                'ADMIN_REPORT_ISSUE' => 'Vous avez rencontré une anomalie ? Veuillez la signaler sur GitHub.',
                'EMAIL_FOOTER' => '<a href="http://getgrav.org">Propulsé par Grav</a> - Le Flat File CMS Moderne',
                'LOGIN_BTN' => 'Connexion',
                ...
                'LOGIN_BTN_CREATE_USER' => 'Création d\'un utilisateur',
                ...
                'INSUFFICIENT_PERMISSIONS_FOR_TASK' => 'Vous avez des permissions insuffisantes pour cette tâche',
                ...
                'CACHE_PREFIX_PLACEHOLDER' => 'Dérivé de la base URL (à substituer en entrant une chaîne aléatoire)',
                ...
                'IMAGES_DEBUG_HELP' => 'Montre une incrustation sur les images indiquant la profondeur de pixel de l\'image lorsque l\'on travaille avec retina par exemple',
                ...
                'TWIG_UMASK_FIX_HELP' => 'Par défaut, Twig va créer des fichiers en 0755, correction en 0775',
                'CACHE_PERMS' => 'Permissions des caches',
                'CACHE_PERMS_HELP' => 'Permissions par défaut pour les dossiers de cache. Habituellement 0755 ou 0775 en fonction des paramètres'
            ],
            'PLUGIN_FORM' => [
...
```',
        ...
        'ja' => [
            'PLUGIN_ADMIN' => [
                ...
                'PASSWORD_VALIDATION_MESSAGE' => 'パスワードは少なくとも数字・大文字・小文字を含む８文字以上である必要があります',
